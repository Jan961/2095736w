...
metric_collection = {'Average quartet stress': 1, 'Stress': 1}
...
layout = LowDLayoutCreation().create_layout(squad, optional_metric_collection=metric_collection, no_iters=5)
