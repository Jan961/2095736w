...
squad = SQuaD(dataset=dataset, initial_layout=Xld, nesterovs_momentum=True)
layout = LowDLayoutCreation().create_layout(squad, optional_metric_collection=None, no_iters=500)
